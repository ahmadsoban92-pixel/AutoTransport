...
export function FeaturesSectionWithHoverEffects() {
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 relative z-10 py-10 max-w-7xl mx-auto overflow-x-clip">
...
const Feature = ({
  ...
  return (
    ...
    >
      ...
      <div className="mb-4 relative z-10 px-4 sm:px-6 lg:px-10 text-orange-400">{icon}</div>
      <div className="text-base lg:text-lg font-bold mb-2 relative z-10 px-4 sm:px-6 lg:px-10">
      ...
      <p className="text-sm text-blue-300 max-w-xs relative z-10 px-4 sm:px-6 lg:px-10">
        {description}
      </p>
    </div>
  );

...
import {
  Star, Shield, Clock, Truck, CheckCircle, ArrowRight, Users, Award, MapPin,
} from "lucide-react";
...
// ─── Static data (module-level = computed once, never on re-render) ───────────
...
const STEPS = [
  { number: "01", title: "Get a Free Quote",        icon: MapPin,      desc: "Fill out our simple form with your vehicle and route details. It takes less than 60 seconds." },
  { number: "02", title: "We Find Your Carrier",    icon: Truck,       desc: "Our team searches our network of 50,000+ vetted carriers to find the best match for your shipment." },
  { number: "03", title: "Your Car Gets Picked Up", icon: CheckCircle, desc: "A certified driver arrives at your door to load your vehicle and begin the journey." },
  { number: "04", title: "Safe Delivery",           icon: Shield,      desc: "Your vehicle arrives at the destination. Inspect it and sign off — it's that simple." },
];

const WHY_US_CARDS = [
  { id: "1", accentColor: "#f97316", topInscription: "50,000+ Active Carriers", mainText: "Massive Network",   subMainText: "Access to the largest carrier network in the US",                 progressBarInscription: "Coverage:",          progress: 100, progressValue: "All 50 States",  filledButtonInscription: "Get Quote", outlinedButtonInscription: "Learn More" },
  { id: "2", accentColor: "#3b82f6", topInscription: "Fully Licensed & Insured", mainText: "Zero Risk",        subMainText: "All carriers are FMCSA registered with active insurance",       progressBarInscription: "Insurance Coverage:", progress: 100, progressValue: "100% Covered",  filledButtonInscription: "Get Quote", outlinedButtonInscription: "Details"    },
  { id: "3", accentColor: "#22c55e", topInscription: "Average quote time",       mainText: "Lightning Fast",   subMainText: "Get competing quotes from top carriers in minutes",             progressBarInscription: "Speed:",             progress: 95,  progressValue: "< 2 Minutes",   filledButtonInscription: "Get Quote", outlinedButtonInscription: "See How"    },
];
